...
public class Main {
    ...
    private static void register() throws IOException {
        ...
        while (!cekValid) {
            ...
            if (user.isEmpty()) {
                ...
                for (akunlonan akun : Dataakunlonan) {
                ...
                if (isExist) {
                    System.out.println("Error: Username sudah digunakan. Silakan gunakan username lain.");
                } else {
                    cekValid = true;
                }
            }
                ...
                do {
                    ...
                    try {
                        ...
                        if (jumlahDibeli <= 0 || jumlahDibeli > hpDibeli.getStokHp()) {
                            System.out
                                    .println("Jumlah stok yang diminta tidak valid. Harap masukkan jumlah yang benar.");
                        }
                    } catch (NumberFormatException e) {
    ...
    private static void update_data() throws NumberFormatException, IOException {
        ...
        try {
            ...
            System.out.print("Masukkan ID dalam bentuk angka.");
            return;
        }
        ...
        if (hpToEdit != null) {
            ...
            hpToEdit.cekKetersediaan();
            // Cek stok terlebih dahulu sebelum melanjutkan fungsi
            ...
            if (!jenis.equals(selectedHPType)) {
                System.out.print("Anda tidak dapat mengedit data jenis HP yang berbeda.");
                return;
            }
    ...
    private static void delete_data() throws IOException {
        ...
        if (hpToDelete != null) {
            ...
            // Periksa apakah jenis HP yang dipilih sebelumnya sesuai dengan tipe HP yang tersedia
            if (!jenis.equals(selectedHPType)) {
                System.out.println("Anda tidak dapat menghapus data jenis HP yang berbeda.");
                return;
            }
